  ...
  switch (token.type) {
    ...
    case 'code': {
      if (options.highlight) {
        token.html = options.highlight(token.text, token.lang);
        if (token.html != null && token.html !== token.text) {
          token.escaped = true;
          token.text = token.html;
        }
      }
